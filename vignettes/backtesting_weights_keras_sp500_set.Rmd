...
save(keras_portfolios_unconstrained_deep_bm, file = "keras_portfolios_constrained_deep_bm.RData")
...
save(keras_portfolios_constrained_shallow, file = "keras_portfolios_unconstrained_shallow_bm.RData")
...
combined_portfolios <- combine_portfolioReturns(list(
  keras_portfolios9_bigger_net,
  keras_portfolios9_shallow_net,
  keras_portfolios_constrained_deep,
  keras_portfolios_constrained_shallow,
  ols_benchmark_portfolios))
