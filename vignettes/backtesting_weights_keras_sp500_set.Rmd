...
# Run the backtest with multiple Keras configurations
keras_portfolios_unconstrained_deep_bm <- backtesting_weights_new(
  data = sp500_m_signals,
  return_label = return_label,
  benchmark_label = "bm_weight",
  mask_label = "sp500_flag",
...
save(keras_portfolios_unconstrained_deep_bm, file = "keras_portfolios_unconstrained_deep_bm.RData")
...
combined_portfolios <- combine_portfolioReturns(list(
  ...
  keras_portfolios_unconstrained_deep_bm,
